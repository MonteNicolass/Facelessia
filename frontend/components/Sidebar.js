...
const NAV_ITEMS = [
  ...
  { href: "/director", label: "Director Pro", icon: "M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" },
  { type: "divider" },
  { href: "/exports", label: "Exports", icon: "M12 10v6m0 0l-3-3m3 3l3-3M3 17V7a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" },
];
      ...
      {recentProjects.length > 0 && (
        <>
          ...
          {recentProjects.map((p) => (
            <div key={p.id} style={{ padding: "4px var(--sp-4)", margin: "0 var(--sp-2)", fontSize: "11px", color: "var(--muted)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
              <span style={{ fontFamily: "var(--font-mono)", fontSize: "9px", color: "var(--dim)", marginRight: "var(--sp-1)" }}>
                {p.type === "studio" ? "STD" : "DIR"}
              </span>
              {p.name}
            </div>
          ))}
